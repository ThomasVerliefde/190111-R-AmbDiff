...
dfDiff01 %>%
  summarize_at(
    vars(a,szr,st0,penalty,fit,time),
...
For fit, it is less clear of an indication, both since p-values are multiplied across multiple conditions, and value is too liberal, since the predictions are fit to the data themselves.
