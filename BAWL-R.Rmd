...
In total (including the words we do not have in the BAWLR),
we will select 8 matching nounPos and 8 matching nounNeg (on letters and frequency).
-> Letters: 5,5,7,7,8,10,10,11
